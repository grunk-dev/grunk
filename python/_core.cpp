...
PYBIND11_MODULE(_core, m)
{
    ...
    .def("active_environment", &grunk::PluginRegistry::active_environment)
    .def("activate_environment", &grunk::PluginRegistry::activate_environment)
    .def("deactivate_environment", &grunk::PluginRegistry::deactivate_environment)
