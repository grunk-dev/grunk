...
if __name__ == '__main__':
    ...
    l_N_add = grunk.expression("l_N_add", "l_N+(-1)", l_N)
    ...
    xcut_Nout = grunk.expression("xcut_Nout", "(s_stator+s_rotor)*0.99", s_stator, s_rotor)
    ...
    grunk.write("20240912/20240912.grr.yml", cavity_recipe)
